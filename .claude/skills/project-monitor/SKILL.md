...
description: See Naql/.claude/skills/project-monitor/SKILL.md for full patterns. Riaya-specific adaptations below.
---
# Project Monitor — Riaya
...
## Apply Naql Patterns
All patterns from Naql's project-monitor skill apply: withRole() wrapper, AuditLog on financial mutations,
