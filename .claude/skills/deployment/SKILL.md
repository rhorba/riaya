---
name: deployment
description: See Naql/.claude/skills/deployment/SKILL.md for full patterns. Riaya-specific adaptations below.
---
# Deployment — Riaya
...
## Apply Naql Patterns
All patterns from Naql's deployment skill apply: withRole() wrapper, AuditLog on financial mutations,
