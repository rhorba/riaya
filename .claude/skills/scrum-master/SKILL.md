---
name: scrum-master
description: See Naql/.claude/skills/scrum-master/SKILL.md for full patterns. Riaya-specific adaptations below.
---
# Scrum Master — Riaya
...
## Apply Naql Patterns
All patterns from Naql's scrum-master skill apply: withRole() wrapper, AuditLog on financial mutations,
