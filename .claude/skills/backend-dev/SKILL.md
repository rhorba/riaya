---
name: backend-dev
description: See Naql/.claude/skills/backend-dev/SKILL.md for full patterns. Riaya-specific adaptations below.
---
# Backend Dev — Riaya
...
## Apply Naql Patterns
All patterns from Naql's backend-dev skill apply: withRole() wrapper, AuditLog on financial mutations,
