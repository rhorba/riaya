...
description: See Naql/.claude/skills/project-manager/SKILL.md for full patterns. Riaya-specific adaptations below.
---
# Project Manager — Riaya
...
## Apply Naql Patterns
All patterns from Naql's project-manager skill apply: withRole() wrapper, AuditLog on financial mutations,
